    ...
    <div className="bg-white rounded-lg shadow-md p-4 border border-gray-100 hover:shadow-lg transition-all duration-300 animate-fade-in">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="parameter-card">
          <h3 className="text-sm font-medium text-gray-500 mb-2">Enthalpy Values</h3>
        ...
        <div className="parameter-card">
          <h3 className="text-sm font-medium text-gray-500 mb-2">Temperature & Pressure</h3>
          <ul className="space-y-2 text-sm">
            <li className="flex justify-between">
              <span>FW Inlet:</span>
